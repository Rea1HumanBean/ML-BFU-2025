...
# Функция для исследования параметров
...
# 1. Визуализация влияния параметров
plt.figure(figsize=(15, 10))

# 1.1. Влияние learning_rate и n_estimators
plt.subplot(2, 2, 1)
for lr in param_grid['learning_rate']:
...
# 1.2. Влияние max_depth и learning_rate
plt.subplot(2, 2, 2)
...
# 1.3. Влияние subsample и colsample_bytree
plt.subplot(2, 2, 3)
for subsample in param_grid['subsample']:
...
# 1.4. Время обучения в зависимости от параметров
plt.subplot(2, 2, 4)
